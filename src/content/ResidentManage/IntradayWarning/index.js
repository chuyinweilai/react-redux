    ...
    return (
      <Col lg={8} md={12} xs={24} key={index} className="IntradayWarning-topCard">
        ...
        <Row className="IntradayWarning-topCard-Bottom">
          ...
          {
            index === 0?
            <Link to="/contant/ResidentManage/IntradayWarning/Stranger"><span style={{color: 'rgba(252, 252, 253, 0.5)'}}>点击查看更多>></span></Link>:
            <Link to={{
    ...
    return (
      <Row>
        ...
        <Col className="IntradayWarning-Bottom">
          ...
          <Table dataSource={this.state.dataSource} onChange={this._sorter.bind(this)} columns={this.columns} rowKey='id' pagination={false} className="Table"/> 
