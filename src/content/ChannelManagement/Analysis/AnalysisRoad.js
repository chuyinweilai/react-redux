...
class AnalysisRoad extends Component{
  constructor(props){
    super(props);
    this.state={
      dataSource: [],
  ...
  _Charts(xValue, yValue){
    ...
    var myChart = echarts.init(this.refs.AnalysisRoad);
    // 绘制图表
    myChart.setOption({
  ...
  render() {
    return (
      <Row>
        <h3 className="Part-Title" >热点位置(主干道占用)</h3>
        <div ref="AnalysisRoad" style={{ width: '100%', height: '2.8rem' }}></div>
      </Row>
    );
  }
}

export default AnalysisRoad;