...
import { appData, Colors, appServer } from './../../../assert';
import './index.css';
...
export default class Devices extends Component{
  ...
  _sorter(pagination, filters, sorter){
    ...
    this.body = body;
    this._getEvent(1, this.openList)
  }
    ...
    return (
      <Row>
        <Col>
          <Row gutter={48}>
            {/* 预警事件比例 */}
            <Col lg={14} xs={24} className='Devices-Charts'>
              <DeviceStatus></DeviceStatus>
            </Col>
            {/* 系统状态 */}
            <Col lg={10} xs={24} className='Devices-System'>
              <SysStatus></SysStatus>
            </Col>
          </Row>
        </Col>
