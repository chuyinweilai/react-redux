...
class HotDoor extends Component{
  constructor(props){
    super(props);
    this.state={
      dataSource: [],
  ...
  _Charts(xValue, yValue){
    ...
    var myChart = echarts.init(this.refs.HotDoor);
    // 绘制图表
    myChart.setOption({
  ...
  render() {
    return (
      <Row>
        <h3 className="Part-Title" >热点门禁</h3>
        <div ref="HotDoor" style={{ width: '100%', height: '2.8rem' }}></div>
      </Row>
    );
  }
}

export default HotDoor;